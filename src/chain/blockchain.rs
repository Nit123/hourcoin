...
impl Blockchain {
	...
	pub fn update_with_block (&mut self, block:Block) -> Result<(), BlockValidationErr> {
		...
		if let Some((coinbase, transactions)) = block.transactions.split_first() {
			...
			let mut block_spent:HashSet<Hash> = HashSet::new(); // input hashes that were spent in this block
			let mut block_created:HashSet<Hash> = HashSet::new(); // (unspent) output hashes generated by this block
